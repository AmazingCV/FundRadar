...
$LogFile = Join-Path $LogDir "fundradar_daily_$Timestamp.log"
$CommandArgs = @("scripts/run_daily_all.py", "--limit", "800")
...
try {
    ...
    Write-RunLog "FundRadar daily runner started"
    ...
    Write-RunLog "FundRadar daily runner finished"
